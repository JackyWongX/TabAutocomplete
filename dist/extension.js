...
const configManager_1 = __webpack_require__(31);
const cacheManager_1 = __webpack_require__(32);
const statusBar_1 = __webpack_require__(37);
const logger_1 = __webpack_require__(4);
const commands_1 = __webpack_require__(38);
const clientFactory_1 = __webpack_require__(3);
/**
 * 激活插件
 * @param context 扩展上下文
 */
async function activate(context) {
    ...
    try {
        ...
        // 初始化客户端工厂
        const clientFactory = new clientFactory_1.ClientFactory(configManager);
        // 测试API连接
        try {
        ...
        // 初始化命令管理器
        const commandManager = new commands_1.CommandManager(configManager, cacheManager, completionProvider, context);
...
class CompletionProvider {
    ...
    constructor(configManager, logger, cacheManager, statusBarItem, diagnosticsCollection, _context) {
        ...
        // 创建客户端工厂
        this.clientFactory = new clientFactory_1.ClientFactory(configManager);
        // 创建API客户端
...
const logger_1 = __webpack_require__(4);
const baseClient_1 = __webpack_require__(5);
const ollamaClient_1 = __webpack_require__(6);
const deepseekClient_1 = __webpack_require__(7);
const openaiClient_1 = __webpack_require__(8);
/**
 * API客户端工厂类
 * 负责根据配置创建适当的API客户端
 */
class ClientFactory {
    ...
    createClient(modelConfig) {
        ...
        switch (modelConfig.provider) {
            case baseClient_1.ModelProvider.OLLAMA:
                return new ollamaClient_1.OllamaClient(this.configManager, modelConfig);
            case baseClient_1.ModelProvider.DEEPSEEK:
                return new deepseekClient_1.DeepSeekClient(this.configManager, modelConfig);
            case baseClient_1.ModelProvider.OPENAI:
                return new openaiClient_1.OpenAIClient(this.configManager, modelConfig);
            default:
 ...
 */
class OllamaClient {
    constructor(configManager, modelConfig) {
        this.configManager = configManager;
        this.logger = logger_1.Logger.getInstance();
        this.modelConfig = modelConfig || {
            title: configManager.getModelName(),
            model: configManager.getModelName(),
            provider: baseClient_1.ModelProvider.OLLAMA,
...
class DeepSeekClient {
    constructor(configManager, modelConfig) {
        this.configManager = configManager;
        this.DEFAULT_API_BASE = 'https://api.deepseek.com/v1';
        this.logger = logger_1.Logger.getInstance();
        this.modelConfig = modelConfig;
     ...
     * @returns 处理后的补全文本
     */
    processCompletionResult(completionText, _context) {
        if (!completionText) {
            return null;
        }
        // 清理补全文本，移除可能的代码块标记
...
class OpenAIClient {
    constructor(configManager, modelConfig) {
        this.configManager = configManager;
        this.DEFAULT_API_BASE = 'https://api.openai.com/v1';
        this.logger = logger_1.Logger.getInstance();
        this.modelConfig = modelConfig;
        if (!this.modelConfig.apiBase) {
            this.modelConfig.apiBase = this.DEFAULT_API_BASE;
...
var max_js_1 = __webpack_require__(10);
Object.defineProperty(exports, "MAX", ({ enumerable: true, get: function () { return max_js_1.default; } }));
var nil_js_1 = __webpack_require__(11);
Object.defineProperty(exports, "NIL", ({ enumerable: true, get: function () { return nil_js_1.default; } }));
var parse_js_1 = __webpack_require__(12);
Object.defineProperty(exports, "parse", ({ enumerable: true, get: function () { return parse_js_1.default; } }));
var stringify_js_1 = __webpack_require__(15);
Object.defineProperty(exports, "stringify", ({ enumerable: true, get: function () { return stringify_js_1.default; } }));
var v1_js_1 = __webpack_require__(16);
Object.defineProperty(exports, "v1", ({ enumerable: true, get: function () { return v1_js_1.default; } }));
var v1ToV6_js_1 = __webpack_require__(19);
Object.defineProperty(exports, "v1ToV6", ({ enumerable: true, get: function () { return v1ToV6_js_1.default; } }));
var v3_js_1 = __webpack_require__(20);
Object.defineProperty(exports, "v3", ({ enumerable: true, get: function () { return v3_js_1.default; } }));
var v4_js_1 = __webpack_require__(23);
Object.defineProperty(exports, "v4", ({ enumerable: true, get: function () { return v4_js_1.default; } }));
var v5_js_1 = __webpack_require__(25);
Object.defineProperty(exports, "v5", ({ enumerable: true, get: function () { return v5_js_1.default; } }));
var v6_js_1 = __webpack_require__(27);
Object.defineProperty(exports, "v6", ({ enumerable: true, get: function () { return v6_js_1.default; } }));
var v6ToV1_js_1 = __webpack_require__(28);
Object.defineProperty(exports, "v6ToV1", ({ enumerable: true, get: function () { return v6ToV1_js_1.default; } }));
var v7_js_1 = __webpack_require__(29);
Object.defineProperty(exports, "v7", ({ enumerable: true, get: function () { return v7_js_1.default; } }));
var validate_js_1 = __webpack_require__(13);
Object.defineProperty(exports, "validate", ({ enumerable: true, get: function () { return validate_js_1.default; } }));
var version_js_1 = __webpack_require__(30);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const validate_js_1 = __webpack_require__(13);
function parse(uuid) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const regex_js_1 = __webpack_require__(14);
...
const rng_js_1 = __webpack_require__(17);
const stringify_js_1 = __webpack_require__(15);
const _state = {};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const parse_js_1 = __webpack_require__(12);
const stringify_js_1 = __webpack_require__(15);
...
const md5_js_1 = __webpack_require__(21);
const v35_js_1 = __webpack_require__(22);
var v35_js_2 = __webpack_require__(22);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const native_js_1 = __webpack_require__(24);
const rng_js_1 = __webpack_require__(17);
const stringify_js_1 = __webpack_require__(15);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.URL = exports.DNS = void 0;
const sha1_js_1 = __webpack_require__(26);
const v35_js_1 = __webpack_require__(22);
var v35_js_2 = __webpack_require__(22);
Object.defineProperty(exports, "DNS", ({ enumerable: true, get: function () { return v35_js_2.DNS; } }));
Object.defineProperty(exports, "URL", ({ enumerable: true, get: function () { return v35_js_2.URL; } }));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const stringify_js_1 = __webpack_require__(15);
const v1_js_1 = __webpack_require__(16);
const v1ToV6_js_1 = __webpack_require__(19);
...
class ConfigManager {
    ...
    loadConfiguration() {
        ...
        // 日志级别
        const logLevel = config.get('logging.level', 'error');
        ...
        // 加载模型配置
        this.cachedConfig.models = config.get('models', []);
        // 如果没有模型配置，添加默认模型
        ...
        // 加载选择的模型索引
        this.cachedConfig.selectedModelIndex = config.get('selectedModelIndex', 0);
        // 加载选择的模型名称
        this.cachedConfig.selectedModelName = config.get('model.selectedModelName', '');
     ...
     * 设置当前选择的模型索引
     */
    async setSelectedModelIndex(index) {
     ...
     * 设置当前选择的模型名称
     */
    async setSelectedModelName(modelName) {
        // 查找模型在数组中的索引
     ...
     * 添加模型配置
     */
    async addModelConfig(modelConfig) {
     ...
     * 更新模型配置
     */
    async updateModelConfig(index, modelConfig) {
     ...
     * 设置当前选择的模型配置
     */
    async setSelectedModelConfig(modelConfig) {
        // 查找模型在数组中的索引
        const index = this.cachedConfig.models.findIndex(m => m.title === modelConfig.title &&
...
const vscode = __importStar(__webpack_require__(1));
const lru_cache_1 = __importDefault(__webpack_require__(33));
const logger_1 = __webpack_require__(4);
...
const Yallist = __webpack_require__(34)
...
try {
  ...
  __webpack_require__(35)(Yallist)
} catch (er) {}
...
class CommandManager {
    constructor(configManager, cacheManager, completionProvider, context) {
        this.configManager = configManager;
        this.cacheManager = cacheManager;
    ...
    showConfig() {
        ...
        // 创建并显示Markdown预览
        const panel = vscode.window.createWebviewPanel('tabAutoCompleteConfig', 'TabAutoComplete 配置', vscode.ViewColumn.One, {});
...
<body>
    ...
    viewAllModels() {
        ...
        // 创建模型信息面板
        const panel = vscode.window.createWebviewPanel('tabAutoCompleteModels', 'TabAutoComplete 模型', vscode.ViewColumn.One, {});
        // 构建HTML内容
        let modelsHtml = '';
    ...
    async addNewModel() {
        ...
        const providerOptions = [
            { label: 'Ollama (本地)', value: baseClient_1.ModelProvider.OLLAMA },
            { label: 'DeepSeek', value: baseClient_1.ModelProvider.DEEPSEEK },
            { label: 'OpenAI', value: baseClient_1.ModelProvider.OPENAI },
            { label: 'SiliconFlow', value: baseClient_1.ModelProvider.SILICONFLOW }
        ];
        ...
        // 如果不是Ollama，需要API密钥
        if (selectedProvider.value !== baseClient_1.ModelProvider.OLLAMA) {
        ...
        const apiBase = await vscode.window.showInputBox({
            ...
            placeHolder: selectedProvider.value === baseClient_1.ModelProvider.OLLAMA ? 'http://localhost:11434' : ''
        });
        if (apiBase) {
            newModel.apiBase = apiBase;
        }
        else if (selectedProvider.value === baseClient_1.ModelProvider.OLLAMA) {
    ...
    async editModel() {
        ...
        // 创建模型配置副本
        const editedModel = { ...selectedModel.model };
        // 编辑模型标题
        const title = await vscode.window.showInputBox({
            prompt: '输入模型显示名称',
        ...
        if (editedModel.provider !== baseClient_1.ModelProvider.OLLAMA) {
            const apiKey = await vscode.window.showInputBox({
        ...
        const currentModelIndex = models.findIndex(m => m.title === currentModel.title &&
